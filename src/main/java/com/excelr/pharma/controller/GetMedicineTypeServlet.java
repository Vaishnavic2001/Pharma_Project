...
/**
 * Servlet implementation class GetMedicineTypeServlet
 */
@WebServlet("/GetMedicineTypeServlet")
public class GetMedicineTypeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			dispatcher = request.getRequestDispatcher("addShipping.jsp");
