...
<title>Add Medicine Type Page : PharmaApplication</title>
	...
	<div class="container">
		<div class="row p-5">
			<div class="col-md-6 offset-md-4">
				<div class="card">
					<div class="card-body">
						<h4 class="text-center text-dark">Add Medicine Types</h4>
						<form action="MedicineTypeServlet" method="post">
							...
							<div class="form-group">
								<label for="exampleInputPassword1">Medicine Type Name</label> <input
									...
									id="exampleInputPassword1" placeholder="Capsules">
							</div>
